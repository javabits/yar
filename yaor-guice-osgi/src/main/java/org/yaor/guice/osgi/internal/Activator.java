...
package org.yaor.guice.osgi.internal;

import org.osgi.framework.BundleActivator;
import org.osgi.framework.BundleContext;
import org.yaor.BlockingSupplierRegistry;
import org.yaor.Registry;
import org.yaor.guice.ExecutionStrategy;
import org.yaor.guice.GuiceYaors;

import static java.lang.Boolean.parseBoolean;
import static org.yaor.guice.ExecutionStrategy.ASYNCHRONOUS;
import static org.yaor.guice.ExecutionStrategy.SYNCHRONOUS;

/**
 * This class is responsible to create the Yaor registry and register it into the OSGi registry under
...
public class Activator implements BundleActivator {
     ...
     */
    public static final String YAOR_DEFAULT_TIMEOUT = "yaor.default.timeout";
    /**
     * property use to lockup to activate synchronous execution strategy that operator can provide through bundle context.
     */
    public static final String YAOR_SYNCHRONOUS_EXECUTION = "yaor.synchronous.execution";
    /**
    ...
    private BlockingSupplierRegistry newRegistry(BundleContext bundleContext) {
        return GuiceYaors.newLoadingCacheBasedBlockingSupplierRegistry(getDefaultTimeout(bundleContext), getExecutionStrategy(bundleContext));
    }

    private ExecutionStrategy getExecutionStrategy(BundleContext bundleContext) {
        String synchronously = bundleContext.getProperty(YAOR_SYNCHRONOUS_EXECUTION);
    ...
    private long getDefaultTimeout(BundleContext bundleContext) {
        String timeout = bundleContext.getProperty(YAOR_DEFAULT_TIMEOUT);
        if (timeout != null) {
