...
package org.yaor.guice.osgi;

import com.google.common.collect.ImmutableList;
import com.google.inject.*;
import org.osgi.framework.*;
import org.yaor.BlockingSupplierRegistry;
import org.yaor.guice.RegistrationHandler;
import org.yaor.guice.RegistryListenerHandler;

import static com.google.common.base.Preconditions.checkNotNull;
import static java.util.Arrays.asList;
import static org.yaor.guice.GuiceYaors.newRegistryDeclarationModule;
...
public final class OSGiYaors {
    ...
    private static Iterable<Module> getModules(BundleContext bundleContext, Iterable<Module> modules) {
        ...
        modulesBuilder.add(newYaorOSGiModule(bundleContext));
        modulesBuilder.addAll(modules);
        return modulesBuilder.build();
    }

    public static Module newYaorOSGiModule(final BundleContext bundleContext) {
