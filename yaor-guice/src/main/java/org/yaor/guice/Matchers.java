...
import static org.yaor.guice.Reflections.getUniqueParameterType;
import static org.yaor.guice.Reflections.isParameterizedType;
...
public final class Matchers {
    ...
    public static <T> Id<T> getYaorKey(Matcher<Key<T>> matcher) {
