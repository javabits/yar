...
import org.yaor.Id;
import org.yaor.Supplier;

import javax.annotation.Nullable;
import java.util.concurrent.TimeUnit;

import static org.yaor.IdMatchers.newKeyMatcher;
 ...
 */
public class BlockingRegistry extends SimpleRegistry implements org.yaor.BlockingRegistry {
    ...
    abstract class AbstractBlockingSupplier<T> extends org.yaor.guice.AbstractBlockingSupplier<T> {
    ...
    private class FirstSupplierProvider<T> implements org.yaor.guice.FirstSupplierProvider<T> {
