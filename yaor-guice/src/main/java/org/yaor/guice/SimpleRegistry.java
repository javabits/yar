...
import static org.yaor.guice.GuiceWatchableRegistrationContainer.newLoadingCacheGuiceWatchableRegistrationContainer;
import static org.yaor.guice.GuiceWatchableRegistrationContainer.newMultimapGuiceWatchableRegistrationContainer;
import static org.yaor.guice.WatcherRegistration.newWatcherRegistration;
...
public class SimpleRegistry implements Registry {
    ...
    SimpleRegistry(WatchableRegistrationContainer registrationContainer) {
        ...
        Thread registryActionThread = new Thread(new RegistryActionHandler(registryActionQueue, registrationContainer), "yaor-action-handler");
    ...
    @Override
    public void remove(org.yaor.Registration<?> registration) {
    ...
    private SupplierRegistration<?> checkSupplierRegistration(org.yaor.Registration<?> registration) {
