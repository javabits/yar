...
import static org.yaor.guice.SupplierRegistryBindingBuilder.checkParameterizedType;
...
public class BlockingSupplierRegistryBindingBuilder<T> extends RegistryBindingBuilder<T> {
    ...
    static class BlockingSupplierRegistryProvider<T> implements Provider<T> {
        ...
        private org.yaor.BlockingSupplierRegistry registry;
        ...
        @Inject
        public void setRegistry(org.yaor.BlockingSupplierRegistry registry) {
